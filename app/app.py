...
with gzip.open("Artifacts/models/book_with_rating.pkl.gz", "rb") as f:
    book_with_rating = pickle.load(f)

with open("Artifacts/models/similarities.pkl","rb")  as f:
    similarities=pickle.load(f)

with open("Artifacts/models/top_30_popular_book.pkl","rb") as f:
    top_30_popular_book=pickle.load(f)

with open("Artifacts/models/pt.pkl","rb") as f:
    pt=pickle.load(f)
